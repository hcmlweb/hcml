  ...
  return (
    <form onSubmit={handleSubmit}>
      <div className="flex flex-col items-center justify-center py-4">
        <h2 className="px-4 py-2 text-sm border-[1px] rounded-md shadow-md border-orange-600">
          Dying Demand Form
        </h2>
      </div>
      <div className="w-full grid grid-cols-1 gap-2 md:grid-cols-2 p-4 border-b-[4px] border-black border-double">
        <div className="w-full grid grid-cols-2">
          ...
          <input
            type="text"
            className="border-[1px] border-gray-800 px-1"
      ...
      {demands.map((demand, index) => (
        <div
          key={index}
          className="grid grid-cols-1 sm:grid-cols-4 sm:gap-8 px-2 sm:px-8"
        >
          <label className="col-span-1 py-2">Color {index + 1}</label>
          <select
            className="col-span-1 border-[1px] border-gray-800 my-1"
            name="colorName"
      ...
      <div className="flex flex-row items-start justify-start space-x-2 py-4">
        <button
          ...
          className="px-4 py-2 bg-blue-500 text-white shadow-md rounded-md hover:bg-blue-600"
        >
          Add More
        </button>
        <button
          type="submit"
          className="px-4 py-2 bg-orange-500 text-white shadow-md rounded-md hover:bg-orange-600"
        >
          Submit
        </button>
      </div>
