...
const LotForm = () => {
  ...
  const [totalThan, setTotalThan] = useState(0);
        ...
        <div className="w-full flex flex-col item-center justify-center p-8 text-xs font-semibold">
          ...
          <div className="w-full border-[1px] border-gray-400 p-4 grid grid-cols-2">
            ...
            <span
              className={`${
                !msg
                  ? "hidden"
                  : "text-green text-lg font-semibold text-green-600"
              }`}
            >
              {msg}
            </span>
          ...
          <div className="w-full border-[1px] border-gray-400 p-4 grid grid-cols-2">
            ...
            >
              ...
              {data.map((party) => {
                return <option key={party._id}>{party.partyName}</option>;
              })}
            </select>
          </div>
          <div className="w-full border-[1px] border-gray-400 p-4 grid grid-cols-2">
          ...
          <div className="w-full border-[1px] border-gray-400 p-4 grid grid-cols-2">
            ...
            <input
              ...
              className="px-4 py-1 border-[1px] border-gray-500 focus:outline-none"
              onChange={(e) => {
                setGriegeLength(e.target.value);
              }}
            />
          </div>
          ...
          <div className="w-full border-[1px] border-gray-400 p-4 grid grid-cols-2">
            ...
            <input
              ...
              className="px-4 py-1 border-[1px] border-gray-500 focus:outline-none"
              onChange={(e) => {
                setFinishingLength(e.target.value);
              }}
            />
          </div>
          ...
          <div className="w-full border-[1px] border-gray-400 p-4 grid grid-cols-2">
            ...
            <input
              ...
              className="px-4 py-1 border-[1px] border-gray-500 focus:outline-none"
              onChange={(e) => {
                setTotalFabrics(e.target.value);
              }}
            />
          </div>
          <div className="w-full border-[1px] border-gray-400 p-4 grid grid-cols-2">
